...
namespace Microsoft.AspNetCore.Components.Routing
{
    ...
    {
        public RouteEntry(RouteTemplate template, [DynamicallyAccessedMembers(Component)] Type handler, IReadOnlyList<string>? unusedRouteParameterNames)
        {
            Template = template;
        ...
        public IReadOnlyList<string>? UnusedRouteParameterNames { get; }
